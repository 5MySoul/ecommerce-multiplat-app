...
{
    public partial class WcbcoreTinTuc
    {
        public WcbcoreTinTuc()
        {
            WcbcoreTepDinhKemTinTucs = new HashSet<WcbcoreTepDinhKemTinTuc>();
        }
        ...
        public string? TenNhomNn { get; set; }
        ...
        public virtual WcbcoreNhomTinTuc? Nhom { get; set; }
        public virtual ICollection<WcbcoreTepDinhKemTinTuc> WcbcoreTepDinhKemTinTucs { get; set; }
    }
}
