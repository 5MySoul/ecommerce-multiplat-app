                                ...
                                <ALink href="#">
                                    <figure className="category-media">
                                        {/* <LazyLoadImage
                                            ...
                                            effect="opacity; transform"
                                        /> */}
                                        <img src="images/categories/category1.png" alt="Category" width="196" height="196" />
                                    </figure>
                                </ALink>
                                ...
                                <ALink href="#">
                                    <figure className="category-media">
                                        {/* <LazyLoadImage
                                            ...
                                            effect="opacity; transform"
                                        /> */}
                                        <img src="images/categories/category2.png" alt="Category" width="196" height="196" />
                                    </figure>
                                </ALink>
                                ...
                                <ALink href="#">
                                    <figure className="category-media">
                                        {/* <LazyLoadImage
                                            ...
                                            effect="opacity; transform"
                                        /> */}
                                        <img src="images/categories/category3.png" alt="Category" width="196" height="196" />
                                    </figure>
                                </ALink>
                                ...
                                <ALink href="#">
                                    <figure className="category-media">
                                        {/* <LazyLoadImage
                                            ...
                                            effect="opacity; transform"
                                        /> */}
                                        <img src="images/categories/category4.png" alt="Category" width="196" height="196" />
                                    </figure>
                                </ALink>
                                ...
                                <ALink href="#">
                                    <figure className="category-media">
                                        {/* <LazyLoadImage
                                            ...
                                            effect="opacity; transform"
                                        /> */}
                                        <img src="images/categories/category5.png" alt="Category" width="196" height="196" />
                                    </figure>
                                </ALink>
                    ...
                    <section className="mt-10 pt-4">
                        ...
                        <OwlCarousel adClass="owl-theme" options={ mainSlider5 }>
                            <div className="category category-absolute category-classic">
                                <figure className="category-media">
                                    <img src="images/categories/category5.jpg" alt="Category" width="280"
                                        height="280" />
                                </figure>
                                <div className="category-content">
                            ...
                            <div className="category category-absolute category-classic">
                                <figure className="category-media">
                                    <img src="images/categories/category6.jpg" alt="Category" width="280"
                                        height="280" />
                                </figure>
                                <div className="category-content">
                                    <h4 className="category-name">Electronics</h4>
                            ...
                            <div className="category category-absolute category-classic">
                                <figure className="category-media">
                                    <img src="images/categories/category7.jpg" alt="Category" width="280"
                                        height="280" />
                                </figure>
                                <div className="category-content">
                            ...
                            <div className="category category-absolute category-classic">
                                <figure className="category-media">
                                    <img src="images/categories/category8.jpg" alt="Category" width="280"
                                        height="280" />
                                </figure>
                                <div className="category-content">
